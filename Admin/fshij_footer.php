...
<div class="contact">
    <div class="container">
        <div class="choose d-choose">
            ...
            <h3 class="t-h3">Forma për fshirjen e Footer-it</h3>
                    ...
                    <tbody style="line-height: 0;text-align: center;">
                        ...
                        if (!empty($_REQUEST['term'])) {
                            ...
                            while ($row = mysqli_fetch_array($sql)) {
                                ...
                                echo "<td><a href=\"delete_footer.php?id_footer=$row[id_footer]\" onClick=\"return confirm('Are you sure you want to delete?')\" class='contact-but-red' style='text-decoration:none;' type='submit'>
										Fshijë</a></td></tr>";
                            }
                        }
