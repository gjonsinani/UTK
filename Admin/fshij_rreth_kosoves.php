...
$result = mysqli_query($conn, "CALL selectRrKs()");
// $result = mysqli_query(
//     $conn,
				...
				<table class="table" style="width: 100%;">
					...
					<tbody style="line-height: 0;text-align: center;">
						...
						if (!empty($_REQUEST['term'])) {
							...
							$sql = mysqli_query($conn, "CALL selectTERMRrKs('$term')");
							while ($row = mysqli_fetch_array($sql)) {
								...
								echo "<td><a href=\"delete_rreth_kosoves.php?id_rrk=$row[id_rrk]\"onClick=\"return confirm('Are you sure you want to delete?')\" class='contact-but-red' style='text-decoration:none;' type='submit'>
										Fshijë</a></td></tr>";
							}
						}
