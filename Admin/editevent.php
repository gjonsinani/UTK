	 ...
	 <div class="contact">
	 	<div class="container">
	 		<div class="choose d-choose">
	 			<h3 class="t-h3">Forma për modifikimin e të dhënave të Eventit</h3>
...
<?php
	...
	while($row = mysqli_fetch_array($sql)) { 		
			...
			echo "<td><a href=\"update_event.php?ID_Eventi=$row[ID_Eventi]\" class='contact-but-green' style='text-decoration:none;' type='submit'>Modifiko</a> </td>";			
		}
