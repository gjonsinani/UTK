		...
		<div class="container">
			<div class="choos-girds">
				<div class="col-md-4 choos-grid">
					...
					<p>Forma për shtimin e ikonave informuese.</p>
					<br>
				...
				<div class="col-md-4 choos-grid">
					...
					<p>Forma për modifikimin e ikonave informuese.</p>
					<br>
				...
				<div class="col-md-4 choos-grid">
					...
					<p>Forma për fshirjen e ikonave informuese.</p>
					<br>
		...
		<div class="container">
			<div class="choos-girds">
				<div class="col-md-4 choos-grid">
					...
					<p>Forma për shtimin e ikonave informuese.</p>
					<br>
					<button onclick="location.href='shto_rreth_kosoves.php'" type="button" class="contact-but-blue">
						Shto</button>
				</div>
				...
				<div class="col-md-4 choos-grid">
					...
					<p>Forma për modifikimin e ikonave informuese.</p>
					<br>
					<button onclick="location.href='modifiko_rreth_kosoves.php'" type="button" class="contact-but-green">
						Modifiko</button>
				</div>
				...
				<div class="col-md-4 choos-grid">
					...
					<p>Forma për fshirjen e ikonave informuese.</p>
					<br>
					<button onclick="location.href='fshij_rreth_kosoves.php'" type="button" class="contact-but-red">
						Fshijë</button>
				</div>
				<div class="clearfix"></div>
			</div>
