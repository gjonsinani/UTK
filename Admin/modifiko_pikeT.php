...
<div class="contact">
	 <div class="container" style="padding: 0; margin: 0 2.5%; width: 95%; ">
	 	<div class="choose d-choose">
				...
				<h3 class="t-h3">Forma për modifikimin e pikës turistike</h3>
	...
	while($row = mysqli_fetch_array($sql)) { 		
			...
			echo "<td><a href=\"update_pike.php?ID_pikaT=$row[ID_pikaT]\" class='contact-but-green' style='text-decoration:none;' type='submit'>Modifiko</a> </td>";			
		}
